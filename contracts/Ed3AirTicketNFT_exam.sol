 ...
 */
//1.机票合约继承ERC721、Ownable标准
//请在此处编写代码
/********** Begin **********/
contract Ed3AirTicketNFT is ERC721Enumerable, ERC721URIStorage, ERC721Pausable, ERC721Burnable {
    /********** End **********/
     ...
     */
    //2.在机票合约的构造方法中设定：机票名称、symbol、机票元数据地址、单价、发行数量、发行时间、售卖机票收入获取地址
    //请在此处编写代码
    /********** Begin **********/
    constructor(
        string memory _name,
    ...
    // 3.在机票合约mint方法中使用修饰器校验条件：机票发行时间、供应量是否超过上限、购买携带的原生币是否达到机票单价
    ...
    function mint(address _to) external payable {
        ...
        // 校验用户用于mint的资金是否足够
        /********** End **********/
        //4.在机票合约mint方法中通过TokenIdCounter保障每一个Token的id唯一
        //请在此处编写代码
        /********** Begin **********/
        // 获取代币ID
