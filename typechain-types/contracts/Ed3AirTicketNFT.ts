...
export interface Ed3AirTicketNFTInterface extends utils.Interface {
  functions: {
...
export interface Ed3AirTicketNFT extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: Ed3AirTicketNFTInterface;
